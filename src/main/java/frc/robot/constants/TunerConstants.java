...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(SwerveConstants.TURNING_KP).withKI(SwerveConstants.TURNING_KI).withKD(SwerveConstants.TURNING_KD)
        .withKS(SwerveConstants.TURNING_KS).withKV(SwerveConstants.TURNING_KV).withKA(SwerveConstants.TURNING_KA)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(SwerveConstants.DRIVE_KP).withKI(SwerveConstants.DRIVE_KI).withKD(SwerveConstants.DRIVE_KD)
        .withKS(SwerveConstants.DRIVE_KS).withKV(SwerveConstants.DRIVE_KV).withKA(SwerveConstants.DRIVE_KA);
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.73); // TODO ADJUST MAX SPEED
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.4267578125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.238525390625);
