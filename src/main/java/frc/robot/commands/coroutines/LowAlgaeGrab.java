...
public class LowAlgaeGrab extends SequentialCommandGroup {
    ...
    public LowAlgaeGrab(CommandSwerveDrivetrain swerveDrivetrain, Elevator elevator, CoralShooter coralShooter, AlgaeClaw algaeClaw) {

        addCommands(
            // drive up
            // raise elevator to correct height
            // pivot out and grab algae until grabbed (SAME TIME)
            // pivot in and spit out coral until spit (SAME TIME)
