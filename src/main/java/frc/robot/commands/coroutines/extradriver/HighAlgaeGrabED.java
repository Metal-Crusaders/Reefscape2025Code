...
public class HighAlgaeGrabED extends SequentialCommandGroup {
    
    public HighAlgaeGrabED(CommandSwerveDrivetrain swerveDrivetrain, Elevator elevator, CoralShooter coralShooter, AlgaePivot algaePivot, AlgaeClaw algaeClaw, CommandXboxController driverController) {
