...
public class TwoL3NoAlgaeAutoOpenSide extends SequentialCommandGroup {

    public TwoL3NoAlgaeAutoOpenSide(CommandSwerveDrivetrain swerve, Elevator elevator, AlgaeClaw algaeClaw, AlgaePivot algaePivot, CoralShooter coralShooter) {
