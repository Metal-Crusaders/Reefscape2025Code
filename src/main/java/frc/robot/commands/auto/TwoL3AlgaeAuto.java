...
public class TwoL3AlgaeAuto extends SequentialCommandGroup {

    public TwoL3AlgaeAuto(CommandSwerveDrivetrain swerve, Elevator elevator, AlgaeClaw algaeClaw, AlgaePivot algaePivot, CoralShooter coralShooter) {
