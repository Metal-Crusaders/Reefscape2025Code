...
public class CenterL3AndProcessAuto extends SequentialCommandGroup {

    public CenterL3AndProcessAuto(CommandSwerveDrivetrain swerve, Elevator elevator, CoralShooter coralShooter, AlgaeClaw algaeClaw, AlgaePivot algaePivot) {

        Command resetPose = new InstantCommand(), startToL3, l3ToProcessor;
        Pose2d startingPose;
