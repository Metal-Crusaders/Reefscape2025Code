...
public class CloseDriveToClosestAlgaeOffset extends SequentialCommandGroup {

    private CommandSwerveDrivetrain swerve;
    public CloseDriveToClosestAlgaeOffset(CommandSwerveDrivetrain swerve) {
    ...
    public Pose2d addRCtoFC(Pose2d robotPose) {
        double xOffset = Constants.AutoDriveConstants.ALGAE_ADDITION[0];
        double yOffset = Constants.AutoDriveConstants.ALGAE_ADDITION[1];
